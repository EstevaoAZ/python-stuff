...
Linguagens C/Java Arrays
    ...
    Ou seja, se você criar um array do tipo int e com tamanho 5, este array será sempre do tipo inteiro e poderá ter SEMPRE no máximo 5 valores.

Já em Python:

- Dinâmico: Não possuem tamanho fixo; Ou seja, podemos criar a lista e simplesmente ir adidionando elementos;
...
Para adicionar elementos e valores em listas utitizamos a função append
...
# OBS: Isso não substitui o valor inicial, o mesmo será deslocado para o final da lista.
...
lista6 = [1, 2.34, True, 'Geek', 'd', [1, 2, 4], 423423423424]
print(lista6)
print(type(lista6))
...
print(numeros.index(5, 2))  # buscando a partir do indice 1
print(numeros.index(5, 3))  # buscando a partir do indice 1
# print(numeros.index(5, 4))  # buscando a partir do indice 1
# OBS: Caso não tenha este elemento na lista, será apresentado erro ValueError

# Podemos fazer busca entre dentro de um range, início/fim
print(numeros.index(8, 3, 6)) # Buscar os índices do valor 8, entre os índices 3 a 6
...
print(lista[:4])  # Começa em 0, e pega atçe o índice 3 - 1
...
print(lista[1::2])  # Começa em 1, vai até o fina, de 2 em 2
...
# VEja que utilizamos a cópia via atribuição e compiamos os dados da lista para a nova lista, mas
# após realizarmos modificação em uma das listas, essa modificação se refletiu em ambas as listas.
